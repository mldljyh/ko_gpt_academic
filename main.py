...
def main():
    ...
    title_html = f"<h1 align=\"center\">학술전용 ChatGPT {get_current_version()}</h1>"
    ...
    cancel_handles = []
    with gr.Blocks(title="학술전용 ChatGPT", theme=set_theme, analytics_enabled=False, css=advanced_css) as demo:
        gr.HTML(title_html)
